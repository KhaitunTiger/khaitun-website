...
export function KapiPrice() {
  const { kapiUsdRate } = useWalletContext();
  ...
  return (
    <div className="text-sm font-medium">
      <span className="text-white">KAPI/USD:</span>{' '}
      <span className="text-white">${kapiUsdRate ? formatPrice(kapiUsdRate) : '---'}</span>
    </div>
  );
}
